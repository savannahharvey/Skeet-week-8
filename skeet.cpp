   ...
   switch (time.level())
   {
      ...
      case 1:
         ...
         if (birds.size() == 0 && random(0, 15) == 1)
            birds.push_back(new StandardInterface(size, 7.0, 10, dimensions));
      ...
      case 2:
         ...
         // spawns when there is nothing on the screen
         if (birds.size() == 0 && random(0, 15) == 1)
            birds.push_back(new StandardInterface(size, 7.0, 12, dimensions));

         // spawn every 4 seconds
         if (random(0, 4 * 30) == 1)
            birds.push_back(new StandardInterface(size, 5.0, 12, dimensions));
         // spawn every 3 seconds
         if (random(0, 3 * 30) == 1)
            birds.push_back(new SinkerInterface(size, 4.5, 20, dimensions));
         break;
      ...
      case 3:
         ...
         // spawns when there is nothing on the screen
         if (birds.size() == 0 && random(0, 15) == 1)
            birds.push_back(new StandardInterface(size, 5.0, 15, dimensions));
         ...
         // spawn every 4 seconds
         if (random(0, 4 * 30) == 1)
            birds.push_back(new SinkerInterface(size, 4.0, 22, dimensions));
         // spawn every 4 seconds
         if (random(0, 4 * 30) == 1)
            birds.push_back(new FloaterInterface(size, 5.0, 15, dimensions));
         break;
      ...
      case 4:
         ...
         // spawns when there is nothing on the screen
         if (birds.size() == 0 && random(0, 15) == 1)
            birds.push_back(new StandardInterface(size, 4.0, 18, dimensions));
         ...
         // spawn every 4 seconds
         if (random(0, 4 * 30) == 1)
            birds.push_back(new SinkerInterface(size, 3.5, 25, dimensions));
         // spawn every 4 seconds
         if (random(0, 4 * 30) == 1)
            birds.push_back(new FloaterInterface(size, 4.0, 25, dimensions));
         // spawn every 4 seconds
         if (random(0, 4 * 30) == 1)
            birds.push_back(new CrazyInterface(size, 4.5, 30, dimensions));
         break;
